            ...
            <Container>
                ...
                <Row>
                    <Col>
                        ...
                        <br />
                        <div className='description'><span className='color'>PROJECT 3:</span> I am serving as the lead front-end developer for an ERP system designed specifically for my pharmacy, utilizing Next.js and Tailwind CSS. In collaboration with a team of backend developers and another front-end developer, I am spearheading the construction of this system, ensuring seamless integration of front-end functionalities with backend systems to optimize pharmacy operations. To view the prototype in Figma, <a className='figma' href='https://www.figma.com/design/NPdqrMmvFgbL5lSCF2jipy/ERP-System?t=QDoEvwAB6NHHI8Tw-0' target='_blank' rel='noopener noreferrer'>CLICK HERE</a>.</div>
                        <br />
                        <div className='description'>You can find the code for most of my projects on my GitHub account. To view, <a className='figma' href='https://github.com/ephnie-o/' target='_blank' rel='noopener noreferrer'>CLICK HERE</a>.</div>
                    </Col>
                </Row>
            </Container>
        </section>
